...
OPENAI_RESPONSES_MAX_INPUT_TOKENS = _optional_int_env(
    "OPENAI_RESPONSES_MAX_INPUT_TOKENS"
)
...
if OPENAI_RESPONSES_MAX_INPUT_TOKENS is not None:
    _validate_web_search_setting(
        OPENAI_RESPONSES_MAX_INPUT_TOKENS,
        1,
        2_000_000,
...
MIDDLEWARE = [
    ...
    'newsradar.accounts.middleware.ApiKeyAuthenticationMiddleware',
...
CELERY_TASK_DEFAULT_QUEUE = "newsradar"
